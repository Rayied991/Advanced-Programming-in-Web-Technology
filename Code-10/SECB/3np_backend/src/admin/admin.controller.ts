import { Body, Controller, Get, Param,Put, Post, Query, UsePipes, ValidationPipe, UseInterceptors, UploadedFile, Res, ParseIntPipe, Session, UnauthorizedException, UseGuards, NotFoundException, HttpStatus, HttpException } from "@nestjs/common";
...
export class AdminController{
    ...
    @Post('/SendEmail')
    async sendEmail(@Body() mydata: any): Promise<string> {
